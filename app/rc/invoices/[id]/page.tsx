    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                      ...
                      <div className="grid grid-cols-2 gap-3 text-sm">
                        {line.RENTAL && (
                          <div>
                            ...
                            <Link href={`/rc/rentals/${line.RENTAL.rentalId}`} className="text-blue-600 hover:underline">
                        ...
                        {line.PO && (
                          <div>
                            ...
                            <Link href={`/rc/purchase-orders/${line.PO.poId}`} className="text-blue-600 hover:underline">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle>Finance Information</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              ...
              <div>
                ...
                <p className="font-medium">{invoice.FIN_STAT || "N/A"}</p>
              </div>
              <div>
          ...
          <Card>
            ...
            <CardContent className="space-y-3">
              <div>
                ...
                <p className="font-medium">{invoice.LAST_UPDT_BY || "N/A"}</p>
              </div>
              <div>
                <p className="text-sm text-muted-foreground">Updated Date</p>
                <p className="font-medium">
                  {invoice.LAST_UPDT_DT
                    ? new Date(invoice.LAST_UPDT_DT).toLocaleString()
                    : "N/A"}
                </p>
              </div>
            </CardContent>
